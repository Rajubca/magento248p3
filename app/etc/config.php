...
return [
    'modules' => [
        ...
        'Shatchi_BannerSlider5' => 1,
        'Shatchi_Catalogue' => 1,
        'Shatchi_CustomCheckout' => 1,
        'Shatchi_CustomContact' => 1,
        'Shatchi_CustomMessages1' => 0,
        'Shatchi_CustomerApproval' => 1,
        'Shatchi_HomePage' => 0,
        'Shatchi_ProductTab' => 0,
        'Shatchi_RemoveJs' => 0,
        'Shatchi_SearchFilter3' => 0,
        'Shatchi_ShowLinked' => 0,
        'Shatchi_SpamTracker' => 0,
        'Shatchi_TradeAccount' => 0,
        'Shatchi_WelcomeMessage' => 0,
        'Smartwave_Core' => 1,
